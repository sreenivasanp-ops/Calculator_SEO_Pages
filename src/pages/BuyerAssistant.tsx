...
const BuyerAssistant = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-hidden">
      ...
      {/* TMT Bar Calculator and Total Summary with Green Border */}
      <div className="max-w-4xl mx-auto px-4 py-6">
        <div className="border-4 border-teal-400 rounded-lg p-6 bg-white">
          {/* Calculator Section */}
