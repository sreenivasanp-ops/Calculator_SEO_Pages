  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-6">
        ...
        {/* TMT Bar Calculator Section - Now as Dialog Trigger */}
        <div className="w-full">
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Card className="mb-6 sm:mb-8 border-2 border-teal-600 hover:border-teal-700 cursor-pointer transition-colors">
              ...
              <div className="xl:hidden">
                  ...
                  <Table className="w-full">
                    <TableHeader>
                      <TableRow className="bg-teal-500 hover:bg-teal-500">
                        <TableHead className="text-white font-semibold text-center text-xs sm:text-sm p-1 sm:p-2 w-[15%]">Diameter</TableHead>
                        ...
                        <TableHead className="text-white font-semibold text-center text-xs sm:text-sm p-1 sm:p-2 w-[20%]">Weight in Kg</TableHead>
                          ...
                          <TableCell className="text-center p-0.5 sm:p-1">
                            <div className="flex justify-center gap-0.5">
                              <Input
                                ...
                                placeholder="0"
                              />
                              <div className="w-10 sm:w-12 h-6 sm:h-8 flex items-center justify-center bg-gray-100 rounded border text-xs text-gray-600">
                                {row.bundleRods}
                              </div>
                            </div>
                          </TableCell>
                ...
                <div className="flex justify-center gap-3 sm:gap-4 mt-4 sm:mt-6">
                  <Button 
                    ...
                    className="bg-teal-500 hover:bg-teal-600 text-white px-4 sm:px-6 py-2 text-sm"
                  >
                    Calculate
                  </Button>
                  <Button 
                    onClick={clearAll}
                    variant="outline" 
                    className="border-orange-500 text-orange-500 hover:bg-orange-50 px-4 sm:px-6 py-2 text-sm"
                  >
                    Clear All
                  </Button>
                </div>
                               ...
                               <TableCell className="text-center p-3 border-r border-gray-200">
                                 <div className="flex justify-center gap-2">
                                    <Input
                                      ...
                                      placeholder=""
                                    />
                                    <div className="w-14 h-8 flex items-center justify-center bg-gray-100 rounded border text-sm text-gray-600">
                                      {row.bundleRods}
                                    </div>
                                 </div>
                               </TableCell>
